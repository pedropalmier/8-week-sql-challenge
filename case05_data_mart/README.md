...
## 💎 Business Context 
Danny launched Data Mart, an online supermarket specializing in fresh produce, and introduced sustainable packaging across the supply chain in June 2020. See the original case study statement [here](https://8weeksqlchallenge.com/case-study-5/).
...
> 💬 **Note**: *Used `53` as the upper bound in `generate_series` to account for the ISO week date system, where some years contain 53 weeks instead of the usual 52.*

...
## ⚡️Problem Statement
Danny needed support to analyze customer behavior using the limited data he had collected over time. The relationship diagram below illustrates the three core tables used in this case. See the original schema [here](schema.sql).

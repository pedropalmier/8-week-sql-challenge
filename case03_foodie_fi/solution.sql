...
-- ============================================================================
/*
QUESTION A1: Based off the 8 sample customers provided in the sample from the subscriptions table (1,2,11,13,15,16,18, 19), write a brief description about each customer’s onboarding journey.
Try to keep it as short as possible - you may also want to run some sort of join to make your explanations a bit easier!
NOTE:
- acquisition_date = first subscription date (trial start)
- activation_date = first paid plan start date (plans 1–3)
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
-- ============================================================================
/*
QUESTION B1: How many customers has Foodie-Fi ever had?
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B2: What is the monthly distribution of trial plan start_date values for our dataset - use the start of the month as the group by value.
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B3: What plan start_date values occur after the year 2020 for our dataset? Show the breakdown by count of events for each plan_name
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
SELECT p.plan_name,
...
/*
QUESTION B4: What is the customer count and percentage of customers who have churned rounded to 1 decimal place?
NOTE: Churn defined as the last plan (plan_id=4). Query isolates each customer’s final plan to avoid double counting and ensure churn is measured at customer level, designed to be robust even if future datasets contain intermediate churn events.
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B5: How many customers have churned straight after their initial free trial - what percentage is this rounded to the nearest whole number?
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B6: What is the number and percentage of customer plans after their initial free trial?
NOTE: Denominator restricted to trial exits to stay valid if customers skip trial.
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B7: What is the customer count and percentage breakdown of all 5 plan_name values at 2020-12-31?
NOTE: Choice to use CTEs for clarity and scalability, reusing snapshot and denominator consistently.
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B8: How many customers have upgraded to an annual plan in 2020?
NOTE: current dataset always starts with trial, so any pro annual in 2020 is an upgrade. However, if direct annual sign-ups existed, they would not count. This universal query ensures only true upgrades are returned.
OWNER: Pedro Palmier
CREATED: 2025-09-11
*/
...
/*
QUESTION B9: How many days on average does it take for a customer to an annual plan from the day they join Foodie-Fi?
OWNER: Pedro Palmier
CREATED: 2025-09-12
*/
...
/*
QUESTION B10: Can you further breakdown this average value into 30 day periods (i.e. 0-30 days, 31-60 days etc)
OWNER: Pedro Palmier
CREATED: 2025-09-12
*/
WITH join_upgrade_dates AS (SELECT s2.customer_id                                         AS customer_id,
...
/*
QUESTION B11: How many customers downgraded from a pro monthly to a basic monthly plan in 2020?
OWNER: Pedro Palmier
CREATED: 2025-09-12
*/
...
/*
QUESTION C1: The Foodie-Fi team wants you to create a new payments table for the year 2020 that includes amounts paid by each customer in the subscriptions table with the following requirements:
...
/*
QUESTION D1: How would you calculate the rate of growth for Foodie-Fi?
OWNER: Pedro Palmier
CREATED: 2025-09-12
...
QUESTION D2: What key metrics would you recommend Foodie-Fi management to track over time to assess performance of their overall business?
OWNER: Pedro Palmier
CREATED: 2025-09-12
...
QUESTION D3: What are some key customer journeys or experiences that you would analyse further to improve customer retention?
OWNER: Pedro Palmier
CREATED: 2025-09-12
...
QUESTION D4: If the Foodie-Fi team were to create an exit survey shown to customers who wish to cancel their subscription, what questions would you include in the survey?
OWNER: Pedro Palmier
CREATED: 2025-09-12
...
[ ] I don’t use it enough to justify the cost (captures low engagement)
[ ] I found a better service (identifies competitive pressure)
[ ] Not enough variety or relevance in the content (highlights dissatisfaction with value)
[ ] The platform was difficult to use (points to usability issues)
[ ] I experienced technical problems (signals product reliability gaps)
[ ] Other [please specify] (leaves room for unanticipated reasons)

QUESTION D5: What business levers could the Foodie-Fi team use to reduce the customer churn rate? How would you validate the effectiveness of your ideas?
OWNER: Pedro Palmier
CREATED: 2025-09-12

...
## 💎 Business Context 
Danny launched Foodie-Fi in 2020 as a subscription streaming service focused exclusively on food content, offering monthly and annual plans for unlimited access. See the original case study statement [here](https://8weeksqlchallenge.com/case-study-3/).
...
> 1. [ ] *What is the main reason you decided to cancel your Foodie-Fi subscription?*
> 2. [ ] *I don’t use it enough to justify the cost (captures low engagement)*
> 3. [ ] *I found a better service (identifies competitive pressure)*
> 4. [ ] *Not enough variety or relevance in the content (highlights dissatisfaction with value)*
> 5. [ ] *The platform was difficult to use (points to usability issues)*
> 6. [ ] *I experienced technical problems (signals product reliability gaps)*
> 7. [ ] *Other [please specify] (leaves room for unanticipated reasons)*
